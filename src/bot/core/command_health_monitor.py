...
class CommandHealthMonitor:
    ...
    def __init__(self):
        ...
        self._recent_executions: Dict[str, list] = defaultdict(list)
        self._alert_callbacks: Dict[str, list] = defaultdict(list)
    ...
    def register_alert_callback(self, command: str, callback: Callable):
        """
    ...
    def reset_metrics(self, command: Optional[str] = None):
