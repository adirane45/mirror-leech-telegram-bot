...
from .repositories import CacheRepository, RateLimitRepository, SessionRepository, StatsRepository, TaskStatusRepository
...
class RedisManager:
    ...
    async def initialize(self, host: str = "redis", port: int = 6379, db: int = 0) -> bool:
        ...
        try:
            ...
            self._client = await aioredis.from_url(  # type: ignore[no-untyped-call]
