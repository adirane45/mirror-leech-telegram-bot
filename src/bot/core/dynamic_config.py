...
class DynamicConfig:
    ...
    def _extract_new_config(self, cm) -> dict:
        """Extract new configuration from module"""
        new_config = {}
    ...
    def _detect_changes(self, new_config: dict) -> list:
    ...
    async def _apply_changes(self, cm, changes: list):
        """Apply and record configuration changes"""
        for key, old_val, new_val in changes:
    ...
    async def reload_config(self) -> bool:
        ...
        async with self._lock:
            try:
                ...
                # Get new config and detect changes
                new_config = self._extract_new_config(cm)
                ...
                await self._apply_changes(cm, changes)
                return True
