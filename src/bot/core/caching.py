...
class DistributedCacheCoherence:
    ...
    def __init__(self) -> None:
        ...
        self.invalidation_log: list[Dict[str, str]] = []
...
class CacheWarmer:
    ...
    def __init__(self, cache: L1MemoryCache):
        self.cache = cache
        self.warming_functions: Dict[str, Callable[[], Any]] = {}
...
class MultiLevelCache:
    ...
    def __init__(self, policy: Optional[CachePolicy] = None):
        ...
        self.l2_callback: Optional[Callable[..., Any]] = None
        self.l3_callback: Optional[Callable[..., Any]] = None

    def set_l2_callback(self, callback: Callable[..., Any]) -> None:
        """Set L2 (Redis) callback"""
        self.l2_callback = callback

    def set_l3_callback(self, callback: Callable[..., Any]) -> None:
