...
from typing import Any, Awaitable, Callable, Dict, List, Optional, Set, TypeAlias, cast

# Import models from refactored health_models module
from .health_models import ComponentHealth, ComponentType, HealthCheck, HealthCheckResult, HealthStatus

logger = getLogger(__name__)

HealthCheckFn: TypeAlias = Callable[[], Awaitable[HealthCheckResult]]
RecoveryCallback: TypeAlias = Callable[[HealthCheckResult], object | Awaitable[object]]
...
class HealthMonitor:
    ...
    def __init__(self) -> None:
        ...
        self._recovery_callbacks: Dict[str, List[RecoveryCallback]] = {}
    ...
    async def register_health_check(
        ...
        try:
            ...
            check_fn_typed = cast(HealthCheckFn, check_fn)

            health_check = HealthCheck(
                check_id=check_id,
                component_type=component_type,
                component_name=component_name,
                check_fn=check_fn_typed,
    ...
    async def _run_health_check(self, check_id: str, health_check: HealthCheck) -> None:
