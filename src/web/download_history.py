...
class DownloadHistory:
    ...
    def add_download(self, download_id: str, url: str, operation: str,
                     destination: str = "", metadata: Optional[Dict[str, Any]] = None) -> bool:
    ...
    def update_download_status(self, download_id: str, status: str,
                               total_size: Optional[int] = None, error: Optional[str] = None) -> bool:
    ...
    def get_download_history(self, limit: int = 100, operation: Optional[str] = None) -> List[Dict[str, Any]]:
